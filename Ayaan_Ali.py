...
def menu():
	...
	cb()
	print (logo)
	print (S + '[☆] ' + G + 'ID Name: ' + R + a['Mahummad Ayaan Tricks'])
	print (S + '[☆] ' + G + 'User ID: ' + R + a['https://www.facebook.com/profile.php?id=100083721820965'])
	print
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + 1 + ' Fast Cloning New Update')
	print (S + '[' + P + '☞2' + S + ']' + 2 + ' Update Ayaan Ali Tool')
	print (S + '[' + P + '☞3' + S + ']' + 3 + ' https://chat.whatsapp.com/EI8nrph9N6jFoVFOSSj7jo')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Ayaan Ali')
	    os.system('cd $HOME && git clone https://github.com/BlackHacking2023125/Ayaan')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To Ayaan_Ali')
	    psb('Congratulations Ayaan_Ali Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Termux✓')
	    psb('🔓Password ☆ User✓')
	    psb('Subscrib My Youtube Channel https://www.youtube.com/@mahummadayaantricks9498✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/ayaan-ali')
	elif bm =='3':
...
def pb():
	...
	print
	raw_input(R + 'Back')
	os.system('python2 Ayaan_Ali143.py')
